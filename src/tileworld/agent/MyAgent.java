...
public class MyAgent extends TWAgent {
  ...
  public void communicate() {
    ...
    // 时刻共享fuelStation的信息
    TWFuelStation fuelStation = getEnvironment().findFuelStation(this, sensor.sensorRange);
    if (((MyMemory) getMemory()).getFuelStation() == null && fuelStation != null) {
      System.out.println("Found fuel station!");
      ((MyMemory) getMemory()).setFuelStation(fuelStation);
    }
